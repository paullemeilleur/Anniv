const dictionnaire = {
    "3": {
        ...
        "photo enigme": "",
        "photo souvenir": "Jour1.jpg",
        "indice obtenu": "Martial"
    },
    "2": {
    ...
    "4": {
        "enigme": "Résous ce rébus pour trouver le mot à rentrer dans la zone de texte.",
        "reponse": "barberousse",
        "gage": "Filme toi en train de chanter une chanson de ton choix. <br> Et envoie la vidéo sur le groupe Entre Copains.",
        "photo enigme": "photo4.png",
        "photo souvenir": "Jour4.jpg",
        "indice obtenu": "Histoire"
    },
    "5": {
    ...
    "12": {
        "enigme": "Débrouille toi:<br><br> 0x 64656761676573",
        "reponse": "dégagés",
        "gage": "Envoie un message gênant à ton père, ta mère ou ta soeur. (Le message te sera indiqué par Paul)",
        "photo enigme": "",
...
function doStuff() {
    var e = document.getElementById("mot_jour");
    console.log(e);
    e.innerHTML = dictionnaire[String(day)]["indice obtenu"];
    var photo = document.getElementById("photo_souvenir");
    console.log(photo);
    photo.src = "./Jour/" + dictionnaire[String(day)]["photo souvenir"];
}
